...
module.exports = __webpack_require__("5PWh");
...
// CONCATENATED MODULE: ./components/UpdateArtist.js
...
`;
const UPDATE_ARTIST_MUTATION = external_graphql_tag_default.a`
...
const UpdateArtist = ({
  ...
  const [updateArtistMutation, {
    ...
    error: mutationError
  }] = Object(react_hooks_["useMutation"])(UPDATE_ARTIST_MUTATION);
  const {
    0: state,
    1: setState
...
/* harmony default export */ var components_UpdateArtist = (UpdateArtist);
// CONCATENATED MODULE: ./pages/updateartist.js

var updateartist_jsx = external_react_default.a.createElement;


const Update = props => updateartist_jsx("div", null, updateartist_jsx(components_UpdateArtist, {
  id: props.query.id
}));

/* harmony default export */ var updateartist = __webpack_exports__["default"] = (Update);
