...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_0___default.a {
  ...
  // }
  render() {
    return __jsx("html", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_0__["Head"], null, this.props.styleTags), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_0__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_0__["NextScript"], null)));
  }
...
MyDocument.getInitialProps = async ctx => {
  ...
  const sheets = new styled_components__WEBPACK_IMPORTED_MODULE_1__["ServerStyleSheet"]();
  const originalRenderPage = ctx.renderPage;

  ctx.renderPage = () => originalRenderPage({
    enhanceApp: App => props => sheets.collectStyles(__jsx(App, props))
  });
