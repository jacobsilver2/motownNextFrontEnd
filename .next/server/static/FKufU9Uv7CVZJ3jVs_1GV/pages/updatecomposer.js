...
module.exports = __webpack_require__("QWru");
...
// CONCATENATED MODULE: ./components/UpdateComposer.js
...
const SINGLE_COMPOSER_QUERY = external_graphql_tag_default.a`
...
`;
const UPDATE_COMPOSER_MUTATION = external_graphql_tag_default.a`
...
const UpdateComposer = ({
  ...
  } = Object(react_hooks_["useQuery"])(SINGLE_COMPOSER_QUERY, {
    variables: {
      id: id
    }
  });
  const [updateComposerMutation, {
    loading: mutationLoading,
    error: mutationError
  }] = Object(react_hooks_["useMutation"])(UPDATE_COMPOSER_MUTATION);
  const {
    0: state,
    1: setState
...
/* harmony default export */ var components_UpdateComposer = (UpdateComposer);
// CONCATENATED MODULE: ./pages/updatecomposer.js

var updatecomposer_jsx = external_react_default.a.createElement;


const Update = props => updatecomposer_jsx("div", null, updatecomposer_jsx(components_UpdateComposer, {
  id: props.query.id
}));

/* harmony default export */ var updatecomposer = __webpack_exports__["default"] = (Update);
