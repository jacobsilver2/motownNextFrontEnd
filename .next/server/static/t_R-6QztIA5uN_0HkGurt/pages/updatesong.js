...
module.exports = __webpack_require__("QE4C");
...
// CONCATENATED MODULE: ./components/UpdateSong.js
...
`;
const UPDATE_SONG_MUTATION = external_graphql_tag_default.a`
...
const UpdateSong = ({
  ...
  const [updateSongMutation, {
    ...
    error: mutationError
  }] = Object(react_hooks_["useMutation"])(UPDATE_SONG_MUTATION);
  const {
    0: state,
    1: setState
...
/* harmony default export */ var components_UpdateSong = (UpdateSong);

// CONCATENATED MODULE: ./pages/updatesong.js

var updatesong_jsx = external_react_default.a.createElement;


const Update = props => updatesong_jsx("div", null, updatesong_jsx(components_UpdateSong, {
  id: props.query.id
}));

/* harmony default export */ var updatesong = __webpack_exports__["default"] = (Update);
